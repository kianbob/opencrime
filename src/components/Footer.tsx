      ...
      <div className="max-w-7xl mx-auto px-4 py-12 grid grid-cols-2 md:grid-cols-5 gap-8 text-sm">
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li><a href="https://permitcore.io" className="hover:text-white">PermitCore</a></li>
            <li><a href="https://americanfactbook.org" className="hover:text-white">American Factbook</a></li>
