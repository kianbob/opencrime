...
export default function ArsonPage() {
  ...
  return (
    <main className="max-w-5xl mx-auto px-4 py-10">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({'@context':'https://schema.org','@type':'FAQPage',mainEntity:[{'@type':'Question',name:'How common is arson in the US?',acceptedAnswer:{'@type':'Answer',text:'Arson is one of the less common but most destructive crimes. The FBI tracks arson separately from other property crimes due to its unique nature and investigation requirements.'}},{'@type':'Question',name:'What type of property is most targeted by arson?',acceptedAnswer:{'@type':'Answer',text:'Residential structures are the most common target, followed by vehicles and commercial buildings. The FBI breaks down arson data by property type in their annual reports.'}},{'@type':'Question',name:'What is the arson clearance rate?',acceptedAnswer:{'@type':'Answer',text:'Arson has one of the lowest clearance rates of any crime, making it difficult to solve. Fire damage often destroys evidence, complicating investigations.'}}]}) }} />
