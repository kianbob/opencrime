...
export const metadata: Metadata = {
  title: 'US Crime Rate 2026 — National Statistics, Trends & Data',
  description: 'Is crime really going down? The 2026 FBI data says yes — 359.1 per 100K, the lowest in years. But some states buck the trend dramatically. See the full breakdown.',
...
export default function CrimeRatePage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <Breadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'US Crime Rate 2026' }]} />
      <h1 className="font-heading text-3xl md:text-4xl font-bold mb-4">US Crime Rate 2026</h1>
      ...
      <div className="prose prose-lg max-w-none mb-8">
        ...
        <p>
          In 2026, the United States recorded {fmtNum(n.violentCrime)} violent crimes — a rate of {fmtRate(n.violentRate)} per 
        ...
        <h2 className="font-heading">2026 Crime Breakdown</h2>
        <table>
        ...
        <p>
          ...
          Since then, violent crime has fallen by more than half. The 2026 rate of {fmtRate(n.violentRate)} is roughly 
        ...
        <h2 className="font-heading">Historical Crime Rates 2005–2026 (CIUS Data)</h2>
        <p>
          The following table shows crime rates per 100,000 population from the FBI&apos;s Crime in the United States (CIUS) reports,
          covering 2005 through 2026. This provides a granular view of how each crime type has trended over two decades.
        </p>
      </div>
      ...
      <div className="prose prose-lg max-w-none mb-8">
        ...
        <p>Crime rates vary enormously by state. The top 5 states by violent crime rate in 2026:</p>
      </div>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        mainEntity: [
          { '@type': 'Question', name: 'What is the US crime rate in 2026?', acceptedAnswer: { '@type': 'Answer', text: `The US violent crime rate in 2026 is ${n.violentRate.toFixed(1)} per 100,000 residents, based on ${n.violentCrime.toLocaleString()} reported violent crimes.` }},
          { '@type': 'Question', name: 'Is crime going up or down in America?', acceptedAnswer: { '@type': 'Answer', text: 'Crime is going down. Violent crime dropped 5.4% from 2023 to 2026 and is down 52.6% from the 1991 peak. The US is safer now than at any point since the 1960s.' }},
          { '@type': 'Question', name: 'What is the US murder rate?', acceptedAnswer: { '@type': 'Answer', text: `The US murder rate in 2026 is ${n.homicideRate.toFixed(2)} per 100,000, with ${n.homicide.toLocaleString()} total murders. This is a 15.7% decline from 2023.` }},
        ]
      })}} />

      <ExploreMore currentPath="/crime-rate" />
      <p className="text-sm text-gray-500 mt-8">
        Source: FBI Crime Data Explorer, SRS Estimated Crimes. Last updated August 2026.
      </p>
      <LastUpdated />
    </div>
  );
