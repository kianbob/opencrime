...
export const metadata: Metadata = {
  title: 'Most Dangerous Cities in America 2026 — Crime Rate Rankings',
  description: 'Which US city has a violent crime rate 7x the national average? See the full 2026 FBI rankings of 332 large cities by violent crime, murder, and property crime rates.',
...
export default function DangerousCitiesPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      <Breadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Most Dangerous Cities in America 2026' }]} />
      ...
      <div className="prose prose-lg max-w-none mb-8">
        ...
        <p>
          ...
          and aggravated assaults per 100,000 residents. The national average in 2026 was {fmtRate(natRate)}.
        </p>
        <p>
      ...
      <div className="prose prose-lg max-w-none mb-8">
        ...
        <p>Based on 2026 FBI violent crime data, {dangerous[0].city}, {dangerous[0].state} has the highest violent crime rate at {fmtRate(dangerous[0].violentRate)} per 100,000 residents — {(dangerous[0].violentRate / natRate).toFixed(1)}x the national average.</p>
        ...
        <p>No. Violent crime in 2026 dropped 5.4% from 2023 and is down 52.6% from the 1991 peak. The current violent crime rate of 359.1 per 100K is historically low — comparable to the late 1960s.</p>
      </div>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        mainEntity: [
          { '@type': 'Question', name: 'What is the most dangerous city in America?', acceptedAnswer: { '@type': 'Answer', text: `Based on 2026 FBI data, ${dangerous[0].city}, ${dangerous[0].state} has the highest violent crime rate at ${dangerous[0].violentRate.toFixed(1)} per 100,000.` }},
          ...
          { '@type': 'Question', name: 'Is crime getting worse in America?', acceptedAnswer: { '@type': 'Answer', text: 'No. Violent crime in 2026 dropped 5.4% from 2023 and is down 52.6% from the 1991 peak.' }},
        ]
      })}} />

      <p className="text-sm text-gray-500 mt-8">
        Source: FBI Crime Data Explorer, 2026. The FBI cautions against using data to rank communities.
