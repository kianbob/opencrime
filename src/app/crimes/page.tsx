...
export default function CrimesPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context":"https://schema.org","@type":"Dataset","name":"Crime Types — Violent Crime, Property Crime, Murder, Robbery & More","description":"Explore all major crime types tracked by the FBI. Violent crime, property crime, murder, rape, robbery, assault, burglary, larceny, motor vehicle theft — with 45 years of national trends.","url":"https://www.opencrime.us/crimes","creator":{"@type":"Organization","name":"OpenCrime","url":"https://www.opencrime.us"},"license":"https://www.opencrime.us/about","sourceOrganization":"FBI Crime Data Explorer"}` }} />
